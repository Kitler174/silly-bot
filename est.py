...
print(f"Is DML available? {is_available()}")
print(f"Number of available devices: {device_count()}")
print(f"Device 0 name: {device_name(0)}")
print(f"Default device id: {default_device()}")
print(f"Default device type: {type(device(default_device()))}")
print(repr(device(default_device())))